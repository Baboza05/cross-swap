;; asset-swapper
;; This contract manages cross-chain asset swapping and transfer mechanisms
;; on the Stacks blockchain. It provides a comprehensive system for securely
;; exchanging digital assets across different blockchain networks, ensuring
;; atomic swaps, maintaining transfer records, and facilitating interoperable
;; token exchanges with minimal trust requirements.
;; Error Constants
